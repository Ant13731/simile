...
\begin{gather}
  ...
  \begin{prooftree}
    \hypo{r: relation[T_1, T_2, relational\_domain=d, relational\_range=r]}
    \infer1{r^{-1}: relation[T_2, T_1, relational\_domain=r, relational\_range=d]}
  \end{prooftree}
  \\
  \tag{Size}
  \begin{prooftree}
  ...
  \begin{prooftree}
    \hypo{r: relation[T_1, T_2, relational\_domain\_min=m]}
    \infer1{r^{-1}: relation[T_2, T_1, relational\_domain\_max=m]}
  \end{prooftree}
  \\
  \tag{Relational Domain max swap}
  \begin{prooftree}
    \hypo{r: relation[T_1, T_2, relational\_domain\_max=m]}
    \infer1{r^{-1}: relation[T_2, T_1, relational\_domain\_min=m]}
  \end{prooftree}
  \\
  \tag{Relational Range min swap}
  \begin{prooftree}
    \hypo{r: relation[T_1, T_2, relational\_range\_max=m]}
    \infer1{r^{-1}: relation[T_2, T_1, relational\_range\_min=m]}
  \end{prooftree}
  \\
...
\begin{gather}
  ...
  \tag{Domain}
  \begin{prooftree}
    \hypo{s: relation[T, V, relational\_domain=d]}
    \hypo{t: relation[V, U, relational\_range=r]}
    \infer2{s \circ t: relation[T, U, relational\_domain=d, relational\_range=r]}
  \end{prooftree}
  \\
  \tag{Empty}
  \begin{prooftree}
  ...
  \begin{prooftree}
    ...
    \hypo{t: relation[V, U]}
    \hypo{extreumum \in \{relational\_domain\_min, relational\_domain\_min\}}
  ...
  \begin{prooftree}
    ...
    \hypo{extreumum \in \{relational\_range\_min, relational\_range\_min\}}
    \infer3{s \circ t: relation[T, U, extremum=m]}
  \end{prooftree}
\end{gather}
...
\begin{gather}
  ...
  \begin{prooftree}
    \hypo{r: relation[T, V, relational\_domain=d]}
    \hypo{s: set[T, literal=l]}
    \hypo{l \not\subseteq d}
  ...
  \begin{prooftree}
    \hypo{r: relation[T, V, relational\_domain=d_1]}
  ...
  \begin{prooftree}
    \hypo{r: relation[T, V, relational\_domain=d_1, TotalOnDomain]}
  ...
  \begin{prooftree}
    \hypo{r: relation[T, V, relational\_domain\_max=m_1]}
  ...
  \begin{prooftree}
    \hypo{r: relation[T, V, relational\_domain\_min=m_1]}
