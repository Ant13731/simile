...
\begin{gather}
  ...
  \begin{prooftree}
    \hypo{a: Int[min=x]}
    \hypo{b: Int[literal=y]}
    \infer2{(a \text{ div } b): T[min=(\lfloor x / y \rfloor)]}
  \end{prooftree}
  \\
  \tag{Max and literal}
  \begin{prooftree}
    \hypo{a: Int[max=x]}
    \hypo{b: Int[literal=y]}
    \infer2{(a \text{ div } b): T[max=(\lfloor x / y \rfloor)]}
  \end{prooftree}
  \\
  \tag{Literal and min}
  \begin{prooftree}
